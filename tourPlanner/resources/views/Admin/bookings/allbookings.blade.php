...
<div class="card-body">
  ...
  <div id="table" class="dataTables_wrapper container-fluid dt-bootstrap4">
    ...
    @endforeach
      ...
      <tfoot>
        <tr><th rowspan="1" colspan="1">Email</th><th rowspan="1" colspan="1">Contact No</th><th rowspan="1" colspan="1">Booked Date</th><th rowspan="1" colspan="1">Rent Amount</th><th rowspan="1" colspan="1">Booking Placed At</th></th></tr>
      </tfoot>
    </table></div></div>
    {{-- {{ $bookings->links() }} --}}
