                  ...
                  <tr role="row" class="odd">
                    ...
                    <td >
                            @if(($property->admin_permission) == 0)
                                <a href="{{ url('admin/propertyauth/'.sprintf("%s",$property->id ))}}" class="btn btn-info">Authenticate</a>
                            
                            {{-- @else
                                <a href="{{ url('admin/propertyunauth/'.sprintf("%s",$property->id ))}}" class="btn btn-info">Unathenticate</a> --}}
