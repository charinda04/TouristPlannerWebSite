    ...
    <form role="form" method="POST" action="{{url('/user/addrentplace')}}" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input id="title" type="number" class="form-control" name="person" value="{{ $request->no_people }}" required>
                </div>
            </div> 
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input id="title" type="number" class="form-control" name="bed" required>
                </div>
            </div> 
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input id="title" type="number" class="form-control" name="bathroom" required>
                </div>
            </div> 
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input id="title" type="number" class="form-control" name="contact" required>
                </div>
            </div> 
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label>Summary</label>
                    <textarea name="description" class="form-control" rows="3" placeholder="Enter your sumery Here" autocomplete="off"  required></textarea>
                </div>
            </div>
